...
def plot_normalized_sigma_error(data, coil_increments, organized_df):
...
if __name__ == '__main__':
    ...
    plot_normalized_sigma_error(data, coil_increments, organized_df)
    # plot_sigma_error(data, coil_increments)
